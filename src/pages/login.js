    ...
    getMessages = () => {
        if (this.state.loginStatus === 0) {
            ...
            return (<div className="alert alert-warning">
                    <strong>login In!!</strong>Please Wait...
                </div>
            );
        } else if (this.state.loginStatus === 3) {
            return (<div className="alert alert-success">
                    <strong>login Sucesfull!</strong>
                </div>
            );
        } else if (this.state.loginStatus === 4) {
            return (<div className="alert alert-danger">
                    <strong>Invalid Login Detail</strong>
                </div>
            );
        }
    };
        ...
        return (
            <React.Fragment>
                ...
                <div className="login-box">
                    <div className="logo">
                        <a href="javascript:void(0);">Medi<b>Ecom</b></a>
                                ...
                                <i className="material-icons">person</i>
                                    ...
                                    <div className="form-line">
                                        <input type="text" className="form-control" name="username"
                                               placeholder="Username" required autofocus onChange={this.saveInputs}/>
                                    </div>
                                </div>
                                <div className="input-group">
                            <span className="input-group-addon">
                                <i className="material-icons">lock</i>
                                    ...
                                    <div className="form-line">
                                        <input type="password" className="form-control" name="password"
                                               placeholder="Password" required onChange={this.saveInputs}/>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-xs-4">
                                        <button className="btn btn-block bg-pink waves-effect" type="submit"
                                                disabled={this.state.btnDisabled}>SIGN IN
                                        </button>
                                    </div>
                                </div>
